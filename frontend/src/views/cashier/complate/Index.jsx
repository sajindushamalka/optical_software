...
const ComplateInvoice = () => {
    ...
    useEffect(() => {
        axios
            .get('http://localhost:2776/api/cahsier/finished')
    ...
    const handleUserClick = (user) => {
        ...
        console.log(user.cmd_id)

        axios.get(`http://localhost:2776/api/cahsier/${user.cmd_id}`).then((res) => {
                            ...
                            <Table bordered>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Total Amount</td>
                                        <td></td>
                                        <td>{paymentDetails[0].full_amount}</td>
                                    </tr>
...
export default ComplateInvoice;
