...
const OptometristOrders = () => {
    ...
    const [COOD_ID, set_COOD_ID] = useState('');
    const [COOO_ID, set_COOO_ID] = useState('');
    const [COOCI_ID, set_COOCI_ID] = useState('');
    ...
    const handleCardClick = (order) => {
        ...
        axios.get(`http://localhost:2776/api/order/conatct/${order.cmd_id}`).then((res) => {
            ...
            set_COOCI_ID(res.data.coocl_id)
    ...
    const submitMedObjective = async () => {
        try {
            ...
            axios.put(`http://localhost:2776/api/order/report/update/object/${COOO_ID}`, ob).then((res) => {
                console.log(res.data)
                toast('Updated!');
            }).catch((err) => {
                console.log(err)
    ...
    const submitMedDeatils = async () => {
        try {
            ...
            axios.put(`http://localhost:2776/api/order/report/update/${COOD_ID}`, ob).then((res) => {
                console.log(res.data)
            }).catch((err) => {
                console.log(err)
            })
